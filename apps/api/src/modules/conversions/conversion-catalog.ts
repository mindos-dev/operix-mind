import { MockConversionPlugin, type PluginIntegracao } from './plugin.interface.js';
...
export const conversionPlugins: PluginIntegracao[] = [
...
const documents: ConversionCapability[] = [
...
const pdfAdvanced: ConversionCapability[] = [
...
const spreadsheets: ConversionCapability[] = [
...
const images: ConversionCapability[] = [
...
const cad: ConversionCapability[] = [
...
const electronics: ConversionCapability[] = [
...
const media: ConversionCapability[] = [
...
export const conversionCapabilities: ConversionCapability[] = [
  ...documents,
  ...pdfAdvanced,
  ...spreadsheets,
  ...images,
...
export function findPluginByName(nome: string): PluginIntegracao | undefined {
