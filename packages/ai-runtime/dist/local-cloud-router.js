...
function modelFor(runtime) {
    if (runtime === 'local')
        return 'gemma2:9b via Ollama';
    if (runtime === 'api_barata')
        return 'DeepSeek/Qwen econômico';
