...
export function improveUserPrompt(input) {
...
export function translatePromptToEnglish(prompt) {
    const translated = [
...
export function addTechnicalContext(prompt) {
...
export function createTaskContext(request) {
...
export function formatFinalAnswerPortuguese(content) {
    return [
